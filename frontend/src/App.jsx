    ...
    <div className="bg-gray-800 p-6 rounded-lg">
      ...
      <div className="mb-6">
        <button
          ...
          className="bg-yellow-500 px-4 py-2 rounded-md mb-4 hover:bg-yellow-600 w-24 cursor-pointer transition-colors"
        >
          返回
        </button>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gray-700 p-4 rounded-lg">
          ...
          <p className="text-gray-300 whitespace-pre-line">{news.summaryZh}</p>
        </div>
